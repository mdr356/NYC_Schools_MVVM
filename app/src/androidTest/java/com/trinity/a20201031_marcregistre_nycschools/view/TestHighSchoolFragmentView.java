...
import static com.trinity.a20201031_marcregistre_nycschools.view.HighSchoolFragmentViewTest.highSchoolViewModelTest;
...
public class TestHighSchoolFragmentView {
    ...
    public void setup() {
        ...
        FragmentScenario<HighSchoolFragmentViewTest> highSchoolFragmentViewTestFragmentScenario = FragmentScenario.launchInContainer(HighSchoolFragmentViewTest.class);

        // Set the NavController property on the fragment
        highSchoolFragmentViewTestFragmentScenario.onFragment(fragment -> Navigation.setViewNavController(fragment.requireView(), navController));
    ...
    public void showSchoolTest() throws Throwable {
        runOnUiThread(() -> {
            NycHighSchool nyc1 = new Gson().fromJson(content,  NycHighSchool.class);
